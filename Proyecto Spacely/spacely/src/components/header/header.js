            ...
            <nav>
                <ul>
                    ...
                    <nav 
                        ...
                        onClick={(event) => handleImageBorder(event, "starPage")}
                    >
                        <img 
                            className="logos"
                    ...
                    <nav
                        className={`constelationPage ${imageBorders.constelationPage}`}
                        onClick={(event) => handleImageBorder(event, "constelationPage")}
                    >
                        <img
                            className="logos"
                    ...
                    <nav
                        class='moon'
                    >
                        <img className="spacely" src="https://www.citypng.com/public/uploads/small/11665225405lofg3fqxqpy7mcbeogqh8jlzjk0iokds27govilmxrxnuep4ldgireh4jun0hiadzhqmss7mzz4efhqxgxrvcjxxa6ath3ktkn64.png" alt="spacely" />
                    </nav>
                </ul>
            </nav>
        </header>
